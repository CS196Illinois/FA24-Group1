      ...
      <div className={styles.photo}>
        <div className={styles.pad}>
          <div className={styles.box}>
              ...
              <input type="text" placeholder="Enter Password" className={styles.textBox} required />
              <Link href="login/empty" className={styles.signIn}>
                Sign In
              </Link>
              
              {/* Google Login Button with Link to googleLogin page */}
              <Link href="/login/googleLogin">
