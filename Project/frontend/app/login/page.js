...
export default function Login() {
  const handleGoogleLogin = () => {
    ...
    const redirectUri = encodeURIComponent('INSERT');
    ...
    const googleLoginUrl = `https://accounts.google.com/o/oauth2/auth?client_id=${clientId}&redirect_uri=${redirectUri}&response_type=${responseType}&scope=${scope}`;
